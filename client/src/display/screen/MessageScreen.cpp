...
namespace bgg
{
  ...
  void MessageScreen::doEnter()
  {
  }

  void MessageScreen::doExit()
  {
    changeSubscreen(nullptr);
  }

  void MessageScreen::update(sf::Time const &elapsed) noexcept
  {
  ...
  void MessageScreen::onWindowEventExceptClosed(
      std::optional<sf::Event> const &) noexcept
  {
  }

  void MessageScreen::layOutScreen() noexcept
  {
