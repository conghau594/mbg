...
namespace bgg
{
    ...
    public:
        ...
        public:
            ...
            void merge(CandidateMoveInfo &&other)
            {
                quietMoves.merge(other.quietMoves);
                captureMoves.merge(other.captureMoves);
