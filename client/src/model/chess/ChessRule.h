...
namespace bgg
{
	...
	public:
		...
		[[nodiscard]] static auto isValidPieceType(
				std::string const &pieceType) noexcept -> bool;
		[[nodiscard]] static auto isValidPieceColor(
				std::string const &pieceColor) noexcept -> bool;
		...
		[[nodiscard]] static auto isPawnBasicMovePossible(
				std::map<Position, Piece> const &piecePlacements,
				Position const &square,
				std::string const &color) noexcept -> bool;
